...
experiment (\S\ref{sec:operators}).
...
% ── PLACEHOLDER-RQ4 ── 20 分钟补跑完成后替换本节
% 原 T7 数据只有 25 轮 / 6 分钟、thermal 恒 1，未跨过 thermal 2→3 台阶，
% 核心问题（持续负载下 NPU 收益能否维持）未被测到。补跑进行中。
...
in the pipeline against $7.4$\,ms in a tight loop. A three-step experiment
